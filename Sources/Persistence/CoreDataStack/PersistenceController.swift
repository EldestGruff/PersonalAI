...
struct PersistenceController: Sendable {
    ...
    static let preview: PersistenceController = {
        ...
        do {
            ...
            AppLogger.data.error("Failed to create preview data: \(error)")
        }
    ...
    private static func handleLoadError(
        ...
        AppLogger.data.warning("Core Data load error: \(error), \(error.userInfo)")
        ...
        AppLogger.data.debug("Migration error — deleting and recreating store")
        ...
        container.loadPersistentStores { _, retryError in
            ...
            AppLogger.data.info("Store recreated successfully")
        }
    }
